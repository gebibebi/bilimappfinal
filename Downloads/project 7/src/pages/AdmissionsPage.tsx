...
import { AdmissionQuestionComponent } from '../components/admissions';
import { CareerTestComponent } from '../components/career';
...
const AdmissionsPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'faq' | 'career-test'>('faq');
    ...
    <div className="space-y-6">
      ...
      <div className="flex border-b border-gray-200 mb-6">
        ...
        <button
          ...
          onClick={() => setActiveTab('career-test')}
        >
