...
const VoiceChatInput: React.FC<VoiceChatInputProps> = ({ 
  ...
  const handleSendMessage = () => {
    // Для демонстрации мы не будем отправлять реальный audioBlob,
    // вместо этого отправим сообщение с указанием, что это голосовое сообщение
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="flex space-x-2">
          ...
          <Button
            ...
            className={isRecording ? 'text-red-500 border-red-300 bg-red-50' : ''}
          >
